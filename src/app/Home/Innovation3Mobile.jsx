...
export default function Innovation3Mobile() {
  ...
  return (
    <div className="h-fit w-full bg-[#1E1328] flex items-center pb-[10vw] px-[2vw] justify-center">
      <div className="h-full w-full flex max-sm:flex-col items-center gap-[3vw] justify-center">
        {/* Left Block with Rive */}

        <div className="h-[25vh] relative w-full rounded-[3vw] overflow-hidden">
          ...
          <div className="w-full h-full absolute flex flex-col gap-[3vw] items-start justify-start bg-gradient-to-r from-black to-transparent p-[5vw] py-[6vw] inset-0 z-10">
            <p className="text-[6vw] w-[60%] leading-[1.1] text-[#D2C2E6] font-bold">
              Sharing, Recording & Streaming
            </p>
            <p className="text-[3.5vw] w-[30%] leading-[1.1] text-[#D2C2E6] font-bold">
        ...
        {/* Right Side Content */}
        <div className="h-fit flex max-sm:w-full gap-[3vw]  max-sm:flex-row flex-col w-[100%]">
          <div className="h-[40vh] flex flex-col items-center  bg-gradient-to-b p-[2.5vw] from-[#EFC7DB] to-[#692CE4] w-[100%] rounded-[4vw]">
            <div className="h-[30%] w-full flex items-center justify-center">
              <p className="text-white font-bold text-[6vw] leading-[1.2]  w-[50%] text-center">
            ...
            <div className="h-[30%] pb-[2vw] w-full flex flex-col gap-[3vw] items-center justify-center">
              ...
              <p className="text-white font-bold text-[4vw] leading-[1.2] w-full text-center">
          ...
          <div className="h-[40vh] flex flex-col w-full items-center justify-center rounded-[3vw] overflow-hidden bg-[#180E22]">
            <div className="w-full h-full flex flex-col gap-[3vw] p-[4vw]">
              <p className="font-DMM text-transparent bg-gradient-to-b from-[#ffdada] to-[#5f20e4] bg-clip-text uppercase text-[2.5vw]">
                Pocket Clip
              </p>
              <p className="text-transparent bg-gradient-to-b from-[#ffdada] to-[#5f20e4] bg-clip-text text-[6vw] leading-[1.1] font-bold w-full">
                Store your Keikku in your pocket or on your clip
              </p>
            </div>
            <div className="w-[60%] pb-[5vw] h-full flex items-center p-[2vw] justify-end ">
              <img
