...
export default function Features() {
  ...
  return (
    <div id="features" className="h-screen overflow-hidden w-full relative">
      <div className=" z-[100] flex items-center justify-between p-[8vw] max-sm:p-[2.5vw] h-full w-full ">
        {data.map((item, index) => (
          <div
            key={index}
          ...
          >
            ...
            <p className="text-[.9vw] max-sm:py-[2vw] max-sm:text-[3vw] leading-[1.1] font-bold w-[95%] text-center text-background">
              {item.title}
            </p>
          </div>
        ))}
