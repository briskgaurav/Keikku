...
export default function Info() {
  return (
    <div className="h-[80vh] max-sm:h-fit max-sm:py-[15vw] w-full flex   text-[#B5B5B8] flex-col gap-[1vw] items-center justify-end">
      <p className="w-[35%] text-center text-[1.3vw] max-sm:text-[4vw] max-sm:w-[70%] leading-[1.5] font-bold">
      ...
      <p className="w-[35%] text-white text-center text-[1.3vw] max-sm:text-[4vw] max-sm:w-[70%] leading-[1.5] font-bold">
